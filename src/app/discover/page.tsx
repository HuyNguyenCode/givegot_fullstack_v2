        ...
        >
          <svg
            className={`w-3.5 h-3.5 flex-shrink-0 ${
              mentor.trustScore >= 85 ? 'text-emerald-600' : mentor.trustScore >= 45 ? 'text-amber-600' : 'text-red-500'
            }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <span
            className={`text-xs font-semibold ${
              mentor.trustScore >= 85 ? 'text-emerald-700' : mentor.trustScore >= 45 ? 'text-amber-700' : 'text-red-600'
            }`}
          >
