  ...
  if (data.length === 0) {
    return (
      <div className="h-48 flex flex-col items-center justify-center text-gray-400">
        ...
        <p className="text-sm">Chưa có buổi học nào hoàn thành</p>
      </div>
    )
  }
        ...
        return (
          ...
          >
            ...
            <div className="text-right flex-shrink-0 space-y-1">
              ...
              <div
                title="Điểm tin cậy: được tính từ tỷ lệ hoàn thành, đánh giá, thời gian phản hồi và độ uy tín."
